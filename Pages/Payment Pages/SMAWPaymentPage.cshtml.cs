...
{
    public class SMAWPaymentPageModel : PageModel
    {
        private readonly EmailService _emailService;

        public SMAWPaymentPageModel(EmailService emailService)
        {
        ...
        public string? StrandName { get; } = "SMAW (Shielded Metal Arc Welding)";
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = @"INSERT INTO SMAWPaymentTable (StrandName, YearLevel, Semester, FirstName, LastName, PayorsName, Email, AmountPaid) 
