...
{
    public class HUMSSPaymentPageModel : PageModel
    {
        private readonly EmailService _emailService;

        public HUMSSPaymentPageModel(EmailService emailService)
        {
        ...
        public string? StrandName { get; } = "HUMSS (Humanities, Social, Science)";
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = @"INSERT INTO HUMSSPaymentTable (StrandName, YearLevel, Semester, FirstName, LastName, PayorsName, Email, AmountPaid) 
