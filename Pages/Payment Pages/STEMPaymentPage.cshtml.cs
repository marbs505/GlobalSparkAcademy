...
{
    public class STEMPaymentPageModel : PageModel
    {
        private readonly EmailService _emailService;

        public STEMPaymentPageModel(EmailService emailService)
        {
        ...
        public string? StrandName { get; } = "STEM (Science, Technology, Engineering, and Mathematics)";
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = @"INSERT INTO STEMPaymentTable (StrandName, YearLevel, Semester, FirstName, LastName, PayorsName, Email, AmountPaid) 
