...
{
    public class HUMSSEnrollmentPageModel : PageModel
    {
        ...
        #region -- HUMSS Enrollment Properties --
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            return RedirectToPage("/Payment Pages/HUMSSPaymentPage",  new { yearLevel = YearAndTerm.YearLevel, semester = YearAndTerm.Semester });
        }
        ...
        private string SaveFile(IFormFile file, string folderName)
        {
            ...
            string uploadsFolder = Path.Combine("wwwroot", "HUMSS Files", folderName);
        ...
        private string GetTableName()
        {
            ...
            switch (SelectedYearLevel)
            {
                case "Grade 11":
                    ...
                    {
                        case "First Semester":
                            tableName = "HUMSSGrade11FirstSemester";
                            break;
                        case "Second Semester":
                            tableName = "HUMSSGrade11SecondSemester";
                            break;
                    }
                    break;
                ...
                case "Grade 12":
                    ...
                    {
                        case "First Semester":
                            tableName = "HUMSSGrade12FirstSemester";
                            break;
                        case "Second Semester":
                            tableName = "HUMSSGrade12SecondSemester";
                            break;
                    }
                    break;
