...
{
    public class STEMEnrollmentPageModel : PageModel
    {
        ...
        #region -- STEM Enrollment Properties --
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            return RedirectToPage("/Payment Pages/STEMPaymentPage", new { yearLevel = YearAndTerm.YearLevel, semester = YearAndTerm.Semester });
        }
        ...
        private string SaveFile(IFormFile file, string folderName)
        {
            ...
            string uploadsFolder = Path.Combine("wwwroot", "STEM Files", folderName);
        ...
        private string GetTableName()
        {
            ...
            switch (SelectedYearLevel)
            {
                case "Grade 11":
                    ...
                    {
                        case "First Semester":
                            tableName = "STEMGrade11FirstSemester";
                            break;
                        case "Second Semester":
                            tableName = "STEMGrade11SecondSemester";
                            break;
                    }
                    break;
                ...
                case "Grade 12":
                    ...
                    {
                        case "First Semester":
                            tableName = "STEMGrade12FirstSemester";
                            break;
                        case "Second Semester":
                            tableName = "STEMGrade12SecondSemester";
                            break;
                    }
                    break;
