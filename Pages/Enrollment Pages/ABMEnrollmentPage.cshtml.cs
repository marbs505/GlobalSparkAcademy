...
{
    public class ABMEnrollmentPageModel : PageModel
    {
        ...
        #region -- ABM Enrollment Properties --
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            return RedirectToPage("/Payment Pages/ABMPaymentPage", new { yearLevel = YearAndTerm.YearLevel, semester = YearAndTerm.Semester });
        }
        ...
        private string SaveFile(IFormFile file, string folderName)
        {
            ...
            string uploadsFolder = Path.Combine("wwwroot", "ABM Files", folderName);
        ...
        private string GetTableName()
        {
            ...
            switch (SelectedYearLevel)
            {
                case "Grade 11":
                    ...
                    {
                        case "First Semester":
                            tableName = "ABMGrade11FirstSemester";
                            break;
                        case "Second Semester":
                            tableName = "ABMGrade11SecondSemester";
                            break;
                    }
                    break;
                ...
                case "Grade 12":
                    ...
                    {
                        case "First Semester":
                            tableName = "ABMGrade12FirstSemester";
                            break;
                        case "Second Semester":
                            tableName = "ABMGrade12SecondSemester";
                            break;
                    }
                    break;
